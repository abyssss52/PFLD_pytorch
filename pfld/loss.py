...
class PFLDLoss(nn.Module):
    ...
    def forward(self, attribute_gt, landmark_gt, euler_angle_gt, angle, landmarks, train_batchsize, euler_angle_weight):
        # euler_weight = 10
        weight_angle = euler_angle_weight * torch.sum(1 - torch.cos(angle - (euler_angle_gt * np.pi / 180)), axis=1)
